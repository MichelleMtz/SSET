...
class PdfController extends Controller
{
    public function pdf_all()
    {
        ...
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Carrera: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($carreras[$datosGenerales[0]->id_carrera-1]->nombre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Periodo: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($periodos[$datosGenerales[0]->id_periodo-1]->periodo),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Grupo: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($grupos[$datosGenerales[0]->id_grupo-1]->grupo),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Alumno: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->nombre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Edad: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->edad),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Sexo: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->sexo==1?'M':'F'),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Fecha de nacimiento: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->fecha_nacimientos),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Lugar de nacimiento: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->lugar_naciemientos),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Semestre: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($semestres[$datosGenerales[0]->id_semestre-1]->descripcion),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Estado civil: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($estadoC[$datosGenerales[0]->id_estado_civil-1]->desc_ec),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"No. Hijos: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->no_hijos),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Dirección: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->direccion),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"e-mail: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosGenerales[0]->correo),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Tel. Casa: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->tel_casa),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Cel: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->cel),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Nivel Socio-económico"). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Trabaja?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->trabaja==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Ocupación: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->ocupacion),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Horario: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosGenerales[0]->horario),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"No.Cta: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"". utf8_decode($datosGenerales[0]->no_cuenta),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"Beca: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"". utf8_decode($datosGenerales[0]->beca==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"Tipo Beca: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"". utf8_decode($datosGenerales[0]->tipo_beca),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"Estado: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"". utf8_decode($datosGenerales[0]->estado==1?'Regular':'Irregular'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"Turno: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Cell(($pdf->GetPageWidth()-20)/10,3,"". utf8_decode($datosGenerales[0]->turno),1,0,"C");
        $pdf->Ln(3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->SetTextColor(010,010,010);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Bachellerato: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosAntecedentes[0]->id_bachillerato==1?'Tecnico':'General'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Otros estudios: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosAntecedentes[0]->otros_estudios),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,utf8_decode("Años en que curso el bachillerato: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,utf8_decode("Año de terminación: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosAntecedentes[0]->año_terminacion),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Escuela de procedencia: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->escuela_procedente),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Promedio: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->promedio),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"Materias reprobadas en el bachillerato: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosAntecedentes[0]->materias_reprobadas),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Otra carrera iniciada: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosAntecedentes[0]->otra_carrera_ini==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Institución: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosAntecedentes[0]->institucion),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Semestres cursados: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosAntecedentes[0]->semestres_cursados),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Interrupciones en los estudios: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->interrupciones_estudios==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Razones: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->razones_interrupcion),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Cuál fue la razón por la que decidio estudiar en el TESVB?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosAntecedentes[0]->razon_descide_estudiar_tesvb),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Tienes información sobre el perfil profecional de la carrera?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosAntecedentes[0]->sabedel_perfil_profesional),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Tuviste opciones vocacionales por otras carreras?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->otras_opciones_vocales==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Cuales?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->cuales_otras_opciones_vocales),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Te gusta la carrera elegida?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->tegusta_carrera_elegida==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Por qué?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->porque_carrera_elegida),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Suspención después de terminar el bachillerato?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->suspension_estudios_bachillerato==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Razones: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosAntecedentes[0]->razones_suspension_estudios),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Te estimula tu familia en tus estudios?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetTextColor(010,010,010);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Nombre del padre: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->nombre_padre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Edad: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->edad_padre),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Ocupación: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->ocupacion_padre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Lugar de residencia: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->lugar_residencia_padre),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Nombre de la madre: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->nombre_madre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Edad: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->edad_madre),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Ocupación: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->ocupacion_madre),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Lugar de residencia: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->lugar_residencia_madre),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"No. Hermanos: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFamiliares[0]->no_hermanos),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Lugar que ocupas entre ellos: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFamiliares[0]->lugar_ocupas),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Actualmente vives: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"No. de personas: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFamiliares[0]->no_personas),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Perteneces a una etnia indigena: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFamiliares[0]->etnia_indigena==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Cuál?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFamiliares[0]->cual_etnia),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Hablas una lengua indigena: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFamiliares[0]->hablas_lengua_indigena==1?'Si':'No'),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Quién sostiene económicamente tu hogar?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->sostiene_economia_hogar),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Consideras a tu familia: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Nombre del tutor: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFamiliares[0]->nombre_tutor),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Parentesco:  ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->SetTextColor(010,010,010);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Tiempo dedicado a estudiar diariamente fuera de clase: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosHabitos[0]->tiempo_empelado_estudiar==3?'2 horas':'3 horas'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Cómo es tu forma de trabajo intelectual?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("Tu forma de estudio más utlizada: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosHabitos[0]->forma_estudio),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Cómo empleas tu tiempo libre?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosHabitos[0]->tiempo_libre),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"Asignaturas preferidas: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosHabitos[0]->asignatura_preferida),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Por qué?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosHabitos[0]->porque_asignatura),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("Asignaturas que te han sido difíciles: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,utf8_decode("¿Qué opinión tines de ti mismo como estudiante?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->SetTextColor(010,010,010);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Practica regularmente algún deporte?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->practica_deporte==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Especificar: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->especifica_deporte),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Practicas alguna actividad artística?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"Tu pasatiempo favorito: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/2,3,"". utf8_decode($datosFormacion[0]->pasatiempo),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Participas en actividades culturales, sociales?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->actividades_culturales==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Cuáles?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->cuales_act),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Cómo consideras tu estado de salud?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Padeces alguna enfermedad crónica?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFormacion[0]->enfermedad_cronica==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Especificar: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFormacion[0]->especifica_enf_cron),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Tus padres padecen alguna enfermedad crónica?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Te han realizado alguna operación médico-quirúrgica: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->operacion==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿De qué?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->deque_operacion),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Padeces alguna enfermedad visual?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("¿Usas lentes?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosFormacion[0]->usas_lentes==1?'Sí':'No'),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,utf8_decode("¿Tomas medicamento?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFormacion[0]->medicamento_controlado==1?'Sí':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Especificar: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFormacion[0]->especifica_medicamento),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Estatura: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFormacion[0]->estatura),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Peso: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"". utf8_decode($datosFormacion[0]->peso),1,0,"C");
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("¿Has tenido algún acidente grave?: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"". utf8_decode($datosFormacion[0]->accidente_grave==1?'Si':'No'),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,"Relata brevemente: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->SetTextColor(010,010,010);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Rendimiento escolar: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Dominio del propio idioma: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,"Otro idioma: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/8,3,utf8_decode("Conocimientos de cómputo: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Aptitudes especiales: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Comprensión y retención en clase: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Preparación y presentación de examenes: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Aplicación de estrategias de aprendizaje y estudio: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Organización en las actividades de estudio: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Consentración durante el estudio: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/4,3,utf8_decode("Solución de problemas y aprendizaje de las matemáticas: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->Ln(3);
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Condiciones ambientales duarnte el estudio: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        ...
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,utf8_decode("Búsqueda bibliografica: "). utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"". utf8_decode($datosArea[0]->busqueda_bibliografica),1,0,"C");
        $pdf->SetFont('Arial', 'B', 4);
        $pdf->Cell(($pdf->GetPageWidth()-20)/6,3,"Trabajo en equipo: ". utf8_decode(""),1,0,"L");
        $pdf->SetFont('Arial', '', 3);
