    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="" class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a id="btnAsigCoo" @click="addprev()" class="btn btn-success btn-lg btn-block">Agregar</a>
                    </div>
                    <div class="col-md-4">
                        <table class="table table-bordered">
                            <thead>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="canmodal" data-dismiss="modal" @click.prevent="borrar()" >Cancelar</button>
            </div>
        </div>
    </div>
</div>