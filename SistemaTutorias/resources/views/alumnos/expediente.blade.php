                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" value="{{isset($datos[0])?$datos[0]->fecha_nacimientos:''}}" id="fn" name="fecha_nacimiento" class="form-control" placeholder="Fecha de Nacimiento">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input name="parentesco" value="{{isset($datos[2])?$datos[2]->id_parentesco:''}}" id="parentesco" type="text" class="form-control" placeholder="Parentesco">
                                    </div>
                                </div>
                            </div>
